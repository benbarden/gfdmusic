...
mysql -u root -ppass -e "create database gfdmusic;"
mysql -u root -ppass -e "create user 'gfdmusic'@'localhost' identified by 'pass';"
mysql -u root -ppass -e "grant all privileges on gfdmusic.* to 'gfdmusic'@'localhost';"
